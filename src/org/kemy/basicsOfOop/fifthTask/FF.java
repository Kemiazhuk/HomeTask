...
//}
//    @Override
//    public Resume convert(@Nonnull ResumeJpa resumeJpa) {
//        notNull(resumeJpa);
//        return Resume.Builder.create()
//                .withResumeId(resumeJpa.getResumeId())
//                .withJobSeekerId(resumeJpa.getJobSeekerId())
//                .withFileUID(resumeJpa.getFileUID())
//                .withResumeBean(
//                        ResumeBean.Builder.create()
//                                .withDocumentTitle(resumeJpa.getOriginalFileName())
//                                .withApplicationCount(resumeJpa.getApplicationCount())
//                                .withIsActive(isActiveStatus(resumeJpa.getStatusId()))
//                                .withCreatedDate(resumeJpa.getCreated())
//                                .withMimeType(resumeJpa.getFileFormat())
//                                .withExternalResumeId(resumeJpa.getExternalId())
//                                .withExternalJobSeekerId(resumeJpa.getExternalJobSeekerId())
//                                .build())
//                .build();
//    }
//
//    private Boolean isActiveStatus(Integer statusId) {
//        return statusId != null ? ResumeStatus.ACTIVE == ResumeStatus.fromInt(statusId) : null;
//    }
//}